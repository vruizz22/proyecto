...
\begin{flushleft}
	...
	\begin{tikzpicture}
	\begin{axis}[
		title={Relación entre Alpha y Ganancia Esperada},
		xlabel={Alpha},
	...
	\begin{tikzpicture}
		\begin{axis}[
			title={Relación entre K y Ganancia Esperada},
			xlabel={$K \times 10^3$},
			ylabel={Ganancia Esperada (CLP)},
			xmin=20, xmax=50,
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{anexo_xmit1.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{anexo_xmit2.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{ymit1.png}
		\caption{Gráfico 1 de la variable $y_{mit}$.}
		\label{fig:grafica5}
	\end{figure}
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{ymit2.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{zit.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{amt.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{bmit1.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.9]{bmit2.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.6]{dmit1.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.6]{dmit2.png}
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.6]{smt.png}
