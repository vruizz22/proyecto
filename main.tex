...
\begin{flushleft}
	...
	este cargador en el periodo 1 (1.623.244) más el costo de almacenamiento asociado a los días
	correspondientes (1-9) y el costo de instalación en el periodo 10 para la estación 1 (5.878.729)
	resultan \$8.382.898 de gasto total. En cambio, si se compra el cargador en el periodo 10 para
	...
	Finalmente, se considera que el modelo no solo proporciona una solución factible, sino que probablemente roza la optimalidad. Esto se refleja en que las ganancias no cesan a lo largo de los periodos y el modelo se beneficia del comportamiento ante las situaciones mencionadas
