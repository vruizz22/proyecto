...
\begin{flushleft}
	...
	\textbf{Costo de Compra:} El costo de compra de cada cargador es de \$1.600.000 CLP (IVA incluido), según precio de mercado (\cite{charge-cost}). Sin embargo, considerando que COPEC ha suministrado más de 150 estaciones \cite{copec}, se estima que el costo de compra de un cargador para COPEC es de \$500.000  a \$700.000 CLP.
